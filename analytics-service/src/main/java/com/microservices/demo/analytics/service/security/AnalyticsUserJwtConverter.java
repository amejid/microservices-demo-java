...
import com.microservices.demo.analytics.service.Constants;
...
public class AnalyticsUserJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
	...
	public AbstractAuthenticationToken convert(@NonNull Jwt jwt) {
		...
		return Optional
			.ofNullable(this.analyticsUserDetailsService.loadUserByUsername(jwt.getClaimAsString(USERNAME_CLAIM)))
			.map(userDetails -> {
